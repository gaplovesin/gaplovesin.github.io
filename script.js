...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycby6c98DUuLODYvysR2Hgq1SB6HL3t3txa-hauUbnIA48BpUXxC9ZaTAkQVJxAzHX_ct/exec');
...
async function loadAlbum(username, albumName) {
    const response = await fetch(`https://api.github.com/repos/${githubUser}/${repo}/contents/myImages/${albumName}`);
